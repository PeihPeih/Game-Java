...
public class constants{
    ...
    public static class EnemyConstants {
        ...
        public static final int DEMON_WIDTH_DEFAULT = 72;
        public static final int DEMON_HEIGHT_DEFAULT = 32;
        ...
        public static final int DEMON_DRAWOFFSET_X = (int)(26 * Game.SCALE);
        public static final int DEMON_DRAWOFFSET_Y = (int)(9 * Game.SCALE);
